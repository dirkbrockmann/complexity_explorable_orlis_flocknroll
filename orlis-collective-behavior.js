...
var orli = {id:"t1", name: "Orli's Magic Switch",  value: false};	
...
var R_coll = {id:"rcoll", name: "Collision Radius", range: [0,2], value: def_R_coll};
...
var toggles = [
	new widget.toggle(orli).update(rainbow).label("top").size(16)
]
...
var world = d3.selectAll("#collective_behavior_display").append("svg")
...
var controls = d3.selectAll("#collective_behavior_controls").append("svg")
...
agent.append("path")
	...
	.attr("d",tadpole)
	.style("opacity",0)
	.style("fill",function(d){return orli.value ? d3.interpolateRainbow(d.theta/360) : "black"})
...
function runsim(){
	...
	agent.select("path").style("fill",function(d){return orli.value ? d3.interpolateRainbow(d.theta/360) : "black"})
